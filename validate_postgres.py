...
in tools/validate_conformance.py so the two never drift apart.

Usage:
    export DATABASE_URL="postgresql://...railway.app:PORT/railway"
    python validate_postgres.py --csv-dir ../kognivera/data/csv \
        --conformance-script ../kognivera/tools/validate_conformance.py
"""
import argparse
import csv
import glob
