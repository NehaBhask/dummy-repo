#!/usr/bin/env python3
"""
load_data.py — load APS-05's data/csv/*.csv into Postgres via COPY.

Usage:
    export DATABASE_URL="postgresql://...railway.app:PORT/railway"
    python load_data.py --csv-dir ../kognivera/data/csv
    python load_data.py --csv-dir ../kognivera/data/csv --truncate   # wipe first

Requires the schema already applied (see README step 1.5):
    psql "$DATABASE_URL" -f ../kognivera/data/schema.sql
"""
import argparse
import glob
import os
